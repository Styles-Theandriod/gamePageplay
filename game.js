document.addEventListener("DOMContentLoaded", () => {
  ...
  const candyColors = [
    "url(images/red-caandy.png)",
    "url(images/yellow-caandy.png)",
    "url(images/orange-caandy.png)",
    "url(images/purple-caandy.png)",
    "url(images/green-caandy.png)",
    "url(images/blue-caandy.png)",
  ];
  //creating a board for our game
